...
CREATE TABLE public.collectors (
  ...
  approved_zones UUID[], -- Array of zone IDs (no FK constraint for arrays)
...
-- Function to validate geo-fencing (without PostGIS for now)
...
-- Insert sample collectors, facilities and labs
INSERT INTO public.collectors (name, email, phone, license_number, certification_type) VALUES
('Rajesh Kumar', 'rajesh@farmherbs.com', '+91-9876543210', 'HERB-COLLECT-001', 'organic'),
('Priya Sharma', 'priya@greenherbs.com', '+91-9876543211', 'HERB-COLLECT-002', 'wild-harvest'),
('Arun Singh', 'arun@mountainherbs.com', '+91-9876543212', 'HERB-COLLECT-003', 'organic');

INSERT INTO public.facilities (name, facility_type, location, license_number, certifications) VALUES
('Kerala Ayurvedic Processing Unit', 'processing', '{"lat": 10.2, "lng": 76.2, "address": "Kochi, Kerala"}', 'PROC-FAC-001', ARRAY['ISO9001', 'GMP']),
('Himalayan Extraction Facility', 'extraction', '{"lat": 30.2, "lng": 78.2, "address": "Dehradun, Uttarakhand"}', 'PROC-FAC-002', ARRAY['ISO9001', 'HACCP']);

INSERT INTO public.laboratories (name, accreditation_number, location, test_capabilities) VALUES
('Central Ayurvedic Testing Lab', 'LAB-ACCR-001', '{"lat": 28.6, "lng": 77.2, "address": "New Delhi"}', ARRAY['moisture', 'pesticide', 'heavy_metals', 'dna_barcoding']),
('Regional Quality Control Lab', 'LAB-ACCR-002', '{"lat": 19.0, "lng": 72.8, "address": "Mumbai"}', ARRAY['microbial', 'potency', 'moisture']);